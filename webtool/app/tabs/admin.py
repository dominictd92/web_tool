...
class Admin(tk.Frame):
    def __init__(self, parent):
        ...
        log_frame.grid(row=0, sticky=tk.EW)
        ...
        refresh_log_button = ttk.Button(
            log_frame, text="Refresh Location", state=tk.NORMAL, width=10,
